...
def marshal_enc():
    clear()
    os.system('espeak -a 300 "  ENTER,  YOUR,    INSTAGRAM  PROFILE  LINK, "')
    file=input(' ENTER YOUR PROFILE LINK : ')    
    os.system('espeak -a 300 "  Plasse root your device , "')
    filex=input('Plasse root your device.')   
    try:
    ...
    print(' [✓✓]  This tool is paid, and its price is 999 Taka.√'+filex)
#---------- BASE64 ENCRYPTION ------------#
def base64_enc():
    clear()
